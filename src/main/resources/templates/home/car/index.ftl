            ...
            <div class="mui-scroll">
                <div class="app">
                    <div class="main">
                        <div class="banner">
                            <div class="swiper-container">
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide"><img src="/home/image/banner.png"></div>
                                    <div class="swiper-slide"><img src="/home/image/banner.png"></div>
                                </div>
                                <!-- Add Pagination -->
                            ...
                            <div class="search flex align-center">
                                <span class="iconfont icontuoyuan"></span>
                                <input type="text" placeholder="请输入关键字"/>
                            </div>

                            <div class="adban">
                                <img src="/home/image/adban.png"/>
                            </div>
                        </div>
                        <div class="headtop">
                            <div class="seadtop">
                                <div class="soukey flex align-center">
                                    <span class="iconfont icontuoyuan"></span>
                                    <input type="text" placeholder="请输入关键字"/>
                                </div>
                            </div>
                        ...
                        <div class="center">
                            <div class="mui-content mui-scroll-wrapper" style="position: static; padding-top: 0.12rem;"
                                 id="salesContainer">
                                <div class="mui-scrol">
                                    <div id="slist">
                                    </div>
            ...
            success: function (response) {
                ...
                for (var i = 0; i < items.length; i++) {
                    var html = '<div class="splist clearfloat">\n' +
                        '\t\t\t\t\t\t\t\t\t<input type="hidden" id="issueId" name="id" value="'+items[i].id+'"><div class="spleft fl">\n' +
...
<script>
    ...
    //跳到详情页面
    mui("#slist").on("tab",".splist",function () {
        var id = $("#issueId").val();
        alert(id)
    })
</script>
