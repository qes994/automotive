...
<script id="toolbar" type="text/html">
    ...
    <div class="layui-inline">
        <input type="text" class="layui-input" id="phone" placeholder="请输入用户手机号">
    </div>
    <div class="layui-inline">
        <select id="status">
...
<script id="operation" type="text/html">
    ...
    <a class="layui-btn layui-btn-danger layui-btn-xs" lay-event="auth">审核</a>
</script>
<!--操作栏end-->
    ...
    layui.use(['table', 'element','layer', 'jquery'], function () {
        ...
        var dataTable = table.render({
            ...
            , cols: [[ //表头
                ...
                , {
                    field: 'realName', title: '是否实名' ,align:'center', templet: function (data) {
                        if (data.realName == 1) {
                            return '<span data-user-status="1" data-user-id="'+data.id+'"  style="cursor: pointer">实名</span>';
                        }
                        if (data.realName == 2) {
                            return '<span data-user-status="2" data-user-id="'+data.id+'"  style="cursor: pointer">等待实名</span>';
                        }
                        if (data.realName == 3) {
                            return '<span data-user-status="3" data-user-id="'+data.id+'"  style="cursor: pointer">未提交信息</span>';
                        }
                    }
                }
